...
// * For now, we can write a loop that prints the
...
let a = 10; // needs to become 20
let b = 20; // needs to become 10

// ? The first approach would be to just write
// a = b
// b = a
// ? but this won't work for an obvious reason:
// ? The moment we do `a = b`
// ?  -> `a` gets ASSIGNED the value of `b` (which in this case is 20)
// ? So on the next line, when we do `b = a`
// ?  -> `b` gets ASSIGNED the value of `a` (which has been changed to 20)
